...
class cedGallerySliderLoading
{
    ...
    public static function getMarkup(&$params)
    {
        if ($params->get('loading', 0)) {
            ...
            <div style="position: absolute; display: block; background: url(' . JUri::root() . 'media/com_cedgalleryslider/css/img/loading.gif) no-repeat center center;
