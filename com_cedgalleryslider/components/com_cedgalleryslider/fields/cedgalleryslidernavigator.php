...
class JFormFieldCedGallerySliderNavigator extends JFormFieldRadio {

    protected $type = 'cedgalleryslidernavigator';
    ...
    protected function getOptions()
    {
        ...
        foreach ($this->element->children() as $option)
        {
            ...
            $text = '<img src="'.JUri::root().'/media/com_cedgalleryslider/images/navigator/'.$value.'.jpg"  alt="'.$alt.'"  title="'.$alt.'">';
