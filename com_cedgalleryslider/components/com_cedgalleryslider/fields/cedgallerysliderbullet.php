...
class JFormFieldCedGallerySliderBullet extends JFormFieldRadio {

    protected $type = 'cedgallerysliderbullet';
    ...
    protected function getOptions()
    {
        ...
        foreach ($this->element->children() as $option)
        {
            ...
            $text = '<img src="'.JUri::root().'/media/com_cedgalleryslider/images/bullet/'.$value.'.jpg" title="'.$alt.'">';
            $tmp = JHtml::_(
