...
class JFormFieldCedGallerySliderArrow extends JFormFieldRadio
{

    protected $type = 'cedgallerysliderarrow';

    protected $itemsPerLine = 2;
    ...
    protected function getOptions()
    {
        ...
        foreach ($this->element->children() as $option) {
            ...
            $text = '<img src="' . JUri::root() . '/media/com_cedgalleryslider/images/arrow/' . $value . '.jpg" title="' . $alt . '">';

            $skin = intval(explode("-", $value)[1]);
            if ($skin > 1) {
                $disabled == 'disabled';
            }
            $tmp = JHtml::_(
